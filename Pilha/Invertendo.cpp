...
void invertStack(stack<int> &pilhaA, stack<int> &pilhaB, stack<int> &pilhaC){
    ...
    // Transferir elementos de pilhaA para pilhaB
    while (!pilhaA.empty()) {
        pilhaB.push(pilhaA.top());
        pilhaA.pop();
    }
    
    // Transferir elementos de pilhaB para pilhaC
    while (!pilhaB.empty()) {
        pilhaC.push(pilhaB.top());
        pilhaB.pop();
    }
    
    // Transferir elementos de pilhaC de volta para pilhaA
    while (!pilhaC.empty()) {
